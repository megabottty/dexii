...
const addCrush = async (username, crushPayload) => {
  ...
  const newCrush = {
    ...
    relationshipLabels: Array.isArray(crushPayload.relationshipLabels) ? crushPayload.relationshipLabels : [],
    ...
    dateOfBirth: crushPayload.dateOfBirth || null,
...
const updateCrush = async (username, id, crushPayload) => {
  ...
  const updated = {
    ...
    relationshipLabels: Array.isArray(crushPayload.relationshipLabels) ? crushPayload.relationshipLabels : existing.relationshipLabels,
    ...
    dateOfBirth: crushPayload.dateOfBirth !== undefined ? (crushPayload.dateOfBirth || null) : existing.dateOfBirth,
